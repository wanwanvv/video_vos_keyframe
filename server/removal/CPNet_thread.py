...
root_folder9 = os.path.dirname(os.path.realpath(__file__))#当前py所在目录
parent_folder9 = os.path.dirname(root_folder9)
sys.path.append(parent_folder9)
sys.path.append(os.path.join(parent_folder9,'removal'))

from Removal_dataset import DAVIS_Test
from CPNet_model import  CPNet

class InpaintingCPNet_thread():#执行交互式图像分割的ivs子线程类
